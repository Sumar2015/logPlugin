...
jQuery.logPlugin = (function () {
    ...
    */
    ...
    return {
        setMaxCount: function setMaxCount(count) {
            numbEvents = count;
        },
        getArray: function getArray() {
            return localStorage.getItem("logArr");
        },
        setElements: function setElements(elem){
            elements = elem;
        },
        init: function () {
            ...
            if (localStorage.getItem("logArr") == null) {
                ...
                logArray = JSON.parse(localStorage.getItem("logArr"));
